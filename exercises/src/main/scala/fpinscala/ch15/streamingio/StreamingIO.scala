package fpinscala.ch15.streamingio

import fpinscala.ch13.iomonad.{IO,Monad,Free,unsafePerformIO}
...
object SimpleStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.ch13.iomonad.Monad
...
object GeneralizedStreamTransducers {
  ...
  object Process {
    ...
    import fpinscala.ch13.iomonad.IO
    ...
    def runLog[O](src: Process[IO,O]): IO[IndexedSeq[O]] = IO {
      ...
      def go(cur: Process[IO,O], acc: IndexedSeq[O]): IndexedSeq[O] =
        cur match {
          ...
          case Await(req,recv) =>
            val next =
              try recv(Right(fpinscala.ch13.iomonad.unsafePerformIO(req)(E)))
    ...
    import fpinscala.ch13.iomonad.IO0.fahrenheitToCelsius
